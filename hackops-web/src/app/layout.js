...
export const metadata = {
  ...
  author: "theDevArmy",
  keywords: "hackathon login, coding, hackathon near me, Ahmedabad, AIML, Tech",
  // Open Graph metadata
  openGraph: {
    ...
    images: [
      {
        url: 'https://res.cloudinary.com/dscq2qcch/image/upload/v1738856244/hackops/Untitled_design_19_ob0euk.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "HackOps - The Coder's Battlefield",
    description: "Hackops is a community-run hackathon organized by theDevArmy. It is a 36 hours of coffee-fueled competition, focused on solving real-world challenges with incubators and accelerators.",
    image: "https://res.cloudinary.com/dscq2qcch/image/upload/v1738856244/hackops/Untitled_design_19_ob0euk.png", // Replace with the image URL
